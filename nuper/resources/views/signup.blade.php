   ...
   <body class="main-layout">
      ...
      <div id="project" class="project">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                  <div class="loginBox"><h2>Sign Up For Nuper</h2></div>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="loginContainer">
            <form action="newUser" method="post">
                @csrf
                <div class="loginBox"><p><input type="text" name="username" placeholder="username" id="username"></p></div><br>
                <div class="loginBox"><p><input type="text" placeholder="email" id="email" name="email"></p></div><br>
                <div class="loginBox"><p><input type="password" name="password" placeholder="password" id="password"></p></div><br>
                <div class="loginBox"><p><input type="submit" class="read_more" value="Sign Up"></p></div>
            </form>
            <div class="loginBox"><p>Already a member? <a href="login">Login</a></p></div>
      </div>
      </div>
      <!-- end project section -->
      <footer>
